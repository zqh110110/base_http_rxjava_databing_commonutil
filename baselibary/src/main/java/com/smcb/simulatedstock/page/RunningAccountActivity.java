...
//    private CommonAdapter<Object> mBillStockCommonAdapter;
    ...
    private void bindViews() {
        ...
        mStartTimeC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(RunningAccountActivity.this,new DatePickerDialog.OnDateSetListener(){
    ...
    private void initViews() {
        ...
        mRunningAccountTableAdapter = new RunningAccountTableAdapter(RunningAccountActivity.this, mBillStocks);
...
//        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setAbContentView(R.layout.running_account_fragment);
        setTitleText("资金流水");
        bindViews();
        initViews();
        refresh();
