package com.smcb.simulatedstock.library.fixtabheader;
...
import com.smcb.simulatedstock.library.fixtabheader.adapters.TableAdapter;
...
public class TableFixHeaders extends ViewGroup {
	private static final int CAN_MOVE = 10;
