 ...
 */
public class AutoLinearLayout2 extends LinearLayout
{
    private int WIDTH;
    private int HEIGHT;
    ...
    public AutoLinearLayout2(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context,attrs);
    }
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        mRippleColor = typedArray.getColor(
                R.styleable.UIButton_ripple_color, getResources().getColor(R.color.color_pressed_def)
        );
        RIPPLR_ALPHE = typedArray.getInteger(
                R.styleable.UIButton_ripple_alpha, RIPPLR_ALPHE
        );
        mRippleDuration = typedArray.getInteger(
                R.styleable.UIButton_ripple_duration, 800
        );
