...
import com.yanzhenjie.nohttp.sample.view.ToolBar;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected final void onCreate(Bundle savedInstanceState) {
        ...
        mLeftView = LayoutInflater.from(this).inflate(R.layout.back_view, null);
        mToolbar.addLeftView(mLeftView);
